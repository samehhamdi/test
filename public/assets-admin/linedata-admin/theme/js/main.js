...
$(function() {
  ...
  $("#skills").autocomplete({
    ...
    select: function (event, ui) {
      ...
      $("#selected-skills").append('<div class="item" data-id="' + itemId + '"><div class="item-inner"><div class="row"><a href="#" class="col-6 title toggle-disciplies">' + ui.item.value + '</a><div class="col-4 row"><div class="checkbox-group horizontal-group group-sm"><span><input type="radio" name="level-'+ itemId +'" id="l-'+ itemId +'-1"><label for="l-'+ itemId +'-1">1</label></span><span><input type="radio" name="level-'+ itemId +'" id="l-'+ itemId +'-2"><label for="l-'+ itemId +'-2">2</label></span><span><input type="radio" name="level-'+ itemId +'" id="l-'+ itemId +'-3"><label for="l-'+ itemId +'-3">3</label></span><span><input type="radio" name="level-'+ itemId +'" id="l-'+ itemId +'-4"><label for="l-'+ itemId +'-4">4</label></span><span><input type="radio" name="level-'+ itemId +'" id="l-'+ itemId +'-5"><label for="l-'+ itemId +'-5">5</label></span></div></div><div class="col-2"><select class="form-control auto-height"><option>Key</option><option>Major</option><option>Minor</option></select></div</div></div></div>');
      $("#skills").val('');
      $("body, main-menu")
        .getNiceScroll()
        .resize();
